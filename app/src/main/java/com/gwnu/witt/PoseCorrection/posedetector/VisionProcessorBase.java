package com.gwnu.witt.PoseCorrection.posedetector;
/*
...
import com.gwnu.witt.PoseCorrection.FrameMetadata;
import com.gwnu.witt.Data.PreferenceHelper;
import com.gwnu.witt.PoseCorrection.BitmapUtils;
import com.gwnu.witt.PoseCorrection.CameraImageGraphic;
import com.gwnu.witt.PoseCorrection.GraphicOverlay;
import com.gwnu.witt.PoseCorrection.InferenceInfoGraphic;
import com.gwnu.witt.PoseCorrection.ScopedExecutor;
import com.gwnu.witt.PoseCorrection.TemperatureMonitor;
...
public abstract class VisionProcessorBase<T> implements VisionImageProcessor {
    ...
    private void processImage(
        ...
        Bitmap bitmap =
                PreferenceHelper.isCameraLiveViewportEnabled(graphicOverlay.getContext())
                        ? null
    ...
    public void processImageProxy(ImageProxy image, GraphicOverlay graphicOverlay) {
        ...
        Bitmap bitmap = null;
        if (!PreferenceHelper.isCameraLiveViewportEnabled(graphicOverlay.getContext())) {
    ...
    private Task<T> setUpListener(
        ...
        return task.addOnSuccessListener(
                        ...
                        results -> {
                            ...
                            if (!PreferenceHelper.shouldHideDetectionInfo(graphicOverlay.getContext())) {
                                graphicOverlay.add(
